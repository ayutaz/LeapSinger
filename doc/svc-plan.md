...
| 選択 | 根拠 | 見積もり |
|---|---|---|
| **① 学習を続ける** | eval loss が 30,000 step でも**単調減少中**。さらに **flow の step 数を増やすと明るさが戻る**（平均 −17% → −5%）＝**1 step 写像が未収束**という直接の証拠がある | 30,000 step 追加で約 1 時間・**$0.3 前後**。`--run_name m3_base` の再実行で自動再開 |
...
**推奨: ① を先に試す。** 最も安く、**step 数依存という直接の証拠がある**のもこれです。
学習が進んで 1 step 写像が真っ直ぐになれば、多 step に頼らずに明るさが出るはずです。
①で改善しなければ過平滑の線が濃くなり、②の根拠が強まります。**①②③のどれを選んでも、進む前に
...
より多くの clip で測るか、②の GAN へ移るかは改めて判断が要ります。
